...
// show favorite stories when 'favorites' clicked
function navFavoritesClick(e) {
  console.debug("newFavoritesClick", e);
  hidePageComponents();
...
// show user created stories when clicking "my stories"
